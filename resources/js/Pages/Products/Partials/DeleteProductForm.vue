...
const deleteProduct = (productId) => {
    ...
    form.delete(route('products.destroy',{product:productId}), {
        preserveScroll: true,
        ...
        <Modal :show="confirmingProductDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Uma vez que um Produto é deletado todos os dados de vendas relacionado a esse produto também é deletado.
                </p>
