...
<template>
    <form @submit.prevent="form.post(route('products.store'))" enctype="multipart/form-data" class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div>
                ...
                <section>
                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <TextInput @input="form.photo = $event.target.files[0]" accept="image/*" id="photo" type="file" class="mt-1 block w-full block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 " required />
